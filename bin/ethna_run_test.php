...
$test_lib_dir = ETHNA_INSTALL_BASE . '/test/lib';
...
require_once $test_lib_dir . '/TextSimpleReporter.php';
require_once $test_lib_dir . '/TextDetailReporter.php';
require_once $test_lib_dir . '/UnitTestBase.php';
