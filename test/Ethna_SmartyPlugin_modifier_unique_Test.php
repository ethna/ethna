...
/**
 *  Ethna_SmartyPlugin_modifier_unique_Test.php
 *
...
//{{{    Ethna_SmartyPlugin_modifier_unique_Test
/**
 *  Test Case For modifier_unique.php
 *
 *  @access public
 */
class Ethna_SmartyPlugin_modifier_unique_Test extends Ethna_UnitTestBase
{
